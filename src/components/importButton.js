        ...
        <div className="mt-2 flex w-full justify-end">
            <button className="text-xs tracking-wide bg-blue-700 p-1.5 rounded-md text-white font-bold disabled:opacity-70 disabled:cursor-wait" onClick={handleProcessing} disabled={isProcessing}>
                {!isProcessing ? (
                    ...
                    <>
                        <svg aria-hidden="true" className="inline-block w-4 h-4 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
